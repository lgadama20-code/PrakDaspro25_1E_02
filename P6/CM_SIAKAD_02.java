...
public class CM_SIAKAD_02 {
    public static void main(String[] args) {
        ...
        double setara_pancasila02= 0, setara_daspro02 = 0, setara_bing02 = 0;
        double ip02;
        double bobot02;
        ...
        System.out.print("\t\t\t  " + setara_pancasila02);
        ...
        System.out.print("\t  " + setara_daspro02);
        ...
        if (pancasila02 > 39 && daspro02 > 39){
            ...
            System.out.println("Tidak LULUS (Nilai C atau D)");
        } 
        
        if (pancasila02 < 1 && daspro02 < 1) {
            System.out.println("Lulus");
        } else {
            System.out.println("Terdapat Nilai E");
        }
